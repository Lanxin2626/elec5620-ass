...
<?php if ($_SESSION['type'] == "user") { ?>
	...
	<ul class="nav nav-pills">
		...
		<li class="nav-item">
			<a class="nav-link active" href="<?php echo site_url('Mycontroller/editPortfolioPage'); ?>">Edit
				portfolio</a>
		</li>
		<li class="nav-item">
...
<?php if ($_SESSION['type']=="admin") {?>
	...
	<ul class="nav nav-pills">
		...
		<li class="nav-item">
			<a class="nav-link active" href="<?php echo site_url('Mycontroller/editPortfolioPage'); ?>">Edit portfolio</a>
		</li>
		<li class="nav-item">
...
<br><br>
<div class="row">
	<?php echo form_open('Mycontroller/edituserfile'); ?>
	<div class="col-md-8" style="margin:auto; background: white; padding:20px ;
		 box-shadow:10px 10px 5px #888888">
		<div class="form-group">
			<h4 style="text-align: center"><span
					class="label label-default"><i><strong>Edit Portfolio</strong></i></span>
			</h4>
		</div>
		<hr>
		...
		<div class="form-group" style="margin-top: 15px">
			...
			<div class="col-md-12">
				<input  v-model="phone" type="text" class="form-control" name="phone" id="phone"
					   placeholder="<?php echo $userInfo['phone'] ?>">
			</div>
		</div>
		<div class="form-group" style="margin-top: 15px">
			...
			<div class="col-md-12">
				<input  v-model="email" type="text" class="form-control" name="email" id="email"
					   placeholder="<?php echo $userInfo['email'] ?>">
			</div>
		</div>
		<div class="form-group" style="margin-top: 15px">
			<label class="control-label col-md-2" for="que">Secret Question:</label>
			<div class="col-md-12">
				<input  v-model="que" type="text" class="form-control" name="question" id="que"
					   placeholder="<?php echo $userInfo['secret_ques'] ?>">
			</div>
		</div>
		<div class="form-group" style="margin-top: 15px">
			<label class="control-label col-md-2" for="ans">Your Answer:</label>
			<div class="col-md-12">
				<input v-model="ans" type="text" class="form-control" name="answer" id="ans"
					   placeholder="<?php echo $userInfo['answer'] ?>">
			</div>
		</div>
		<div class="form-group" style="margin-top: 15px">
			<div class="col-md-12">
...
<script>
	var app = new Vue({
		...
		methods:{
			checkNull:function(){
				if (this.phone==""||this.email==""||this.que==""||this.ans==""){
